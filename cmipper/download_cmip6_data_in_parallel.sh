...
# EC-Earth3P-HR
python3 download_cmip6_data_parallel.py --source_id EC-Earth3P-HR --variable_id mlotst --member_id r1i1p2f1 --lats '-50' --lats '-40' --lons '130' --lons '140' --levs '0' --levs '2' --resolution 0.25 > testlogs/cmip6_download_logs/MLOTST.txt 2>&1 &
